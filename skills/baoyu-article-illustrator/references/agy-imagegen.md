...
- **`--ref` (up to 3 images)** holds visual/style consistency across illustrations reliably — pass a prior illustration or a style reference as `--ref` and the prompt does not need to redescribe every visual detail.

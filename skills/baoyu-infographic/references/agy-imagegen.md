...
- **`--ref` (up to 3 images)** holds subject/style appearance across generations reliably — pass a prior generation or reference asset as `--ref` and the prompt does not need to redescribe every visual detail.

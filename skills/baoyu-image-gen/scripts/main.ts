...
Environment variables:
  ...
  OPENAI_IMAGE_MODEL        Default OpenAI model (gpt-image-2.5-flare)
  ...
  AZURE_OPENAI_IMAGE_MODEL  Backward-compatible Azure deployment/model alias (defaults to gpt-image-2.5-flare)
